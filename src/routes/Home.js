        ...
        <div class="home_about">
          ...
          <div class="about_text">
            ...
            <p class="about_kr">
              ...
              <br />
              ARAV라는 이름은 내가 처음 개발을 배우게 된 학원에서 친구들이
              지어준 별명이다. 뜻은 평화로운, 지혜(peaceful, wisdom).
              <br />
              ...
              되어야하는데, 나는 비전공자이므로 아예 대학교 학사를 다시
              시작해야만 했다.
              <br />
            ...
            <p className="about_en">
              ...
              <br />
              <br />
              Not long after I started getting to know a develop and dreaming of
              ...
              <br />I was in Berlin for about a year and a half, learning
              German, and having a conversation with a friend who majored in
              computer science at the Free University of Berlin, I became
              interested in development. It was a great experience to take a few
              times lectures with his help.
              ...
              <br />
              After that, in November 2019, I obtained the certificate of
              Engineer Information Processing. And from December 2019, I started
              learning in academy that trains full-stack developers based on
              Java.
              <br />
            ...
            <p className="about_de">
              ...
              kennte einem Freund, der an der Freien Universität Berlin
              Informatik studierte, und interessierte mich für Entwicklung.
              <br />
              ...
              computerbezogenen Bachelor-Abschluss haben. aber ich habe nicht.
              In der Zwischenzeit hörte ich, dass in einer von der Regierung
